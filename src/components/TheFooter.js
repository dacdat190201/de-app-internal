    ...
    <footer className="footer">
      <div className="footer-container container">
        <div className="home-footer-left">
          ...
          <div className="home-footer-left-title">
            We provide information about properties such as houses, villas and
            apartments to help people find their dream home{" "}
          </div>
          <div className="home-footer-left-icon">
            <svg
              width="32"
              height="32"
              viewBox="0 0 32 32"
        ...
        <div className="footer-menu">
          <div className="footer-column">
            ...
            <ul>
              ...
              <li>
                <a href="/about">Apartment</a>
              </li>
              <li>
                <a href="/services">Villa</a>
              </li>
            </ul>
          </div>
          <div className="footer-column">
            ...
            <ul>
              ...
              <li>
                <a href="/about">Popular Article</a>
              </li>
              <li>
                <a href="/services">Most Read</a>
              </li>
              <li>
                <a href="/services">Tips & Tricks</a>
              </li>
            </ul>
          </div>
          <div className="footer-column">
            ...
            <ul>
              ...
              <li>
                <a href="/about">(671) 555-0110</a>
              </li>
              <li>
                <a href="/services">info@hounter.com</a>
              </li>
            </ul>
          </div>
        </div>
